...
exports.postById = (req, res, next, id) => {
	Post.findById(id)
		...
		.select(
			"_id title body created likes comments photo base64VideoData base64AudioData"
		)
		.exec((err, post) => {
			if (err || !post) {
...
exports.createPost = (req, res, next) => {
	console.log("createPost req.body", JSON.stringify(req.body));
